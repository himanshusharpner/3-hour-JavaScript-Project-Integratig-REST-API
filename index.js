window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/697d0addfe604a47a5987285af0acf2d/addExpensesData")
        .then((response) => {
...
function saveToLocalStorage(event) {
    ...
    axios.post("https://crudcrud.com/api/697d0addfe604a47a5987285af0acf2d/addExpensesData", obj)
        .then((response) => {
...
function deleteExpense(trackerId) {
    axios.delete(`https://crudcrud.com/api/697d0addfe604a47a5987285af0acf2d/addExpensesData${trackerId}`)
        .then((response) => {
